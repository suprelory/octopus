        ...
        updatePreset.mutate(
            {
                ...
                data: {
                    ...
                    empty_response_detection: values.empty_response_detection,
                    items,
                },
            },
            {
                ...
                <header className="relative mb-4 flex items-start justify-between gap-4">
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                            <h2 className="truncate pr-4 text-2xl font-bold text-card-foreground">{t('preset.editorTitle')}</h2>
            ...
            >
                <GroupEditor
                    ...
                    initial={{
                        ...
                        empty_response_detection: preset.empty_response_detection ?? true,
