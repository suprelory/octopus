...
import { type SiteModelView, formatHistoryTime, routeTypeLabel, summarizeHistory } from './utils';
        ...
        <div className="w-[24rem] space-y-3 p-4 text-left">
            <div className="space-y-1">
                ...
                <div className="text-[11px] text-muted-foreground">
                    {model.group_name || model.group_key} · 最近请求{' '}
                    {formatHistoryTime(model.history?.last_request_at ?? null)}
                </div>
            </div>
