...
const (
	...
	CodeAuthBootstrapRequired     = "auth.bootstrap_required"
	CodeAuthAlreadyInitialized    = "auth.already_initialized"
	CodeAuthBootstrapTokenInvalid = "auth.bootstrap_token_invalid"
